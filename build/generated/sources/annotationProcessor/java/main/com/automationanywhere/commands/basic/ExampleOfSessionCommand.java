...
public final class ExampleOfSessionCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(ExampleOfSessionCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    ExampleOfSession command = new ExampleOfSession();
